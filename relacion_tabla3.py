...
relacion_tabla = []     # <--- Aquí se crea un array vacío para almacenar los datos de la relación entre usuarios y hijos
...
for usuario in usuarios:    # <--- Aquí se itera sobre los resultados de la consulta
    ...
    apellido_usuario = usuario[2]   # <--- Aquí se obtiene el apellido del usuario
...
relacion_tabla.append(usuarioArray) # <--- Aquí se agrega el array usuarioArray al array relacion_tabla
